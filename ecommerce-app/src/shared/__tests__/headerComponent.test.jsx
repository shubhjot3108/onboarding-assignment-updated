...
describe('HeaderComponent', () => {
  ...
  it('should render correctly', () => {
    render(
        <HeaderComponent currentComponent="Home" cartCount={5} />
    );
  ...
  it('should navigate to correct route when Home is clicked', () => {
    render(
      <Router>
        <HeaderComponent currentComponent="Home" cartCount={0} />
      </Router>
    );
  ...
  it('should navigate to correct route when My Orders is clicked', () => {
    render(
      <Router>
        <HeaderComponent currentComponent="My Orders" cartCount={0} />
      </Router>
    );
  ...
  it('should navigate to correct route when My Cart is clicked', () => {
    render(
      <Router>
        <HeaderComponent currentComponent="My Cart" cartCount={0} />
      </Router>
    );
